...
def get_korean_stopwords():
    ...
    "은성", "예찬", "준수", "도훈", "준희", "다온", "민석", "주안", "건", "도하","송혜교", "전지현", "김태리", "김지원", "김하늘", "김혜수", "김유정", "이나영", "한지민", "박보영",
    ...
    "유아인", "마동석", "강하늘", "황정민", "박서준", "박보검", "손현주", "김유정", "남주혁", "윤계상", "한가은", "이하늬", "한소희", "김지안", "오나라", "박신혜", "손예진", "김태리", "이지은", "이하늬",
    ...
    "송지효", "신봉선", "강은비", "채수빈", "설현", "박세리", "유승호", "김민재", "송중기", "이준기","가", "가까스로", "가령", "각", "각각", "각자", "각종", "갖고말하자면", "같다", "같이", "개의치않고", "거니와",
    ...
    "만이 아니다", "만일", "만큼", "말하자면", "말할것도 없고", "매", "매번", "메쓰겁다", "몇", "모", "모두", "무렵", "가량", "가지", "각", "간", "갖은", "개", "개국", "개년", "개소", "개월", "걔", "거", "거기",
    ...
    "같은", "사람들", "부류의", "사람들", "왜냐하면", "중의하나", "오직", "오로지", "에", "한하다", "하기만", "하면", "도착하다", "까지", "미치다", "도달하다", "정도에", "이르다",
    ...
    "들", "사실", "이렇", "점", "싶", "말", "정도", "좀", "원", "잘", "통하", "놓", "새로운","그러나", "그리고", "그런데", "그래서", "따라서", "하지만", "또", "또는",
    ...
    '김로운', '김태민', '김예성', '김태현', '김윤재', '김주안', '김건', '김주호', '김서은','이지우', '이서윤', '이민준', '이서준', '이서연', '이도윤', '이하윤', '이하은',
    ...
    '이로운', '이태민', '이예성', '이태현', '이윤재', '이주안', '이건', '이주호', '이서은','박지우', '박서윤', '박민준', '박서준', '박서연', '박도윤', '박하윤', '박하은',
    ...
    '박로운', '박태민', '박예성', '박태현', '박윤재', '박주안', '박건', '박주호', '박서은', '촤지우', '촤서윤', '촤민준', '촤서준', '촤서연', '촤도윤', '촤하윤', '촤하은',
    ...
    '촤로운', '촤태민', '촤예성', '촤태현', '촤윤재', '촤주안', '촤건', '촤주호', '촤서은'
